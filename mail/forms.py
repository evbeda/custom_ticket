...
class FormSendEmailPreview(forms.Form):
    ...
    attendee_barcode = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': '752327237937711035001',
                'placeholder': 'Barcode Ticket Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    attendee_first_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'EDAc',
                'placeholder': 'First Name Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    attendee_last_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'Ticket',
                'placeholder': 'Last Name Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    attendee_cost_gross = forms.CharField(
        ...
        widget=forms.NumberInput(
            attrs={
                'value': 0.00,
                'placeholder': 'Cost Gross Ticket Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    attendee_quantity = forms.CharField(
        ...
        widget=forms.NumberInput(
            attrs={
                'value': 1,
                'placeholder': 'Quantity Ticket Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    attendee_question = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                ...
                'placeholder': 'Question Ticket Attendee',
                'class': 'form-control'
            }
        )
    )
    ...
    event_name_text = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'EventTest_With_FreeTicket',
    ...
    event_image = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'https://cdn.pixabay.com/photo/2017/12/08/11/53/event-party-3005668_960_720.jpg',
    ...
    event_venue_location = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'St. Always Live 1234',
                'placeholder': 'Event Venue Adress',
                'class': 'form-control'
            }
        )
    )
    ...
    user_order_first_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'EDAc',
                'placeholder': 'User Order First Name',
                'class': 'form-control'
            }
        )
    )
    user_order_last_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'value': 'Ticket',
                'placeholder': 'User Order Last Name',
                'class': 'form-control'
            }
        )
    )
