...
class FormSendEmailPreview(forms.Form):
    ...
    attendee_question = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={'value': 'What is your favorite color?','placeholder': 'Question Ticket Attendee', 'class': 'form-control'}
        )
    )
    ...
    organizer_logo = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={'value': 'https://upload.wikimedia.org/wikipedia/commons/a/ab/Logo_TV_2015.png','placeholder': 'Organizer Logo URL', 'class': 'form-control'}
        )
    )
    ...
    event_image = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={'value': 'https://cdn.pixabay.com/photo/2017/12/08/11/53/event-party-3005668_960_720.jpg','placeholder': 'Event Image URL', 'class': 'form-control'}
        )
    )
