...
urlpatterns = [
    ...
    url(r'^create-customization/$', ViewCreateCustomization.as_view(), name='create_customizations'),
    url(r'success', ViewCreateCustomization.as_view(), name='success_customizations'),
